...
![ExecutorService interface methods](./threadpool/ExecutorService_interface.png)

顾名思义，不做过多介绍，详情可以见 javadoc 或者 jdk 源码

## ScheduledExecutorService interface

![ScheduledExecutorService interface methods](./threadpool/ScheduledExecutorService_interface.png)
...
![线程池新加入任务的处理流程](./threadpool/ThreadPool_new_task_flow.png)
